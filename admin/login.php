...
<head>
    ...
    // kynd.info 2014
    var candy = document.getElementById('canvas');

    candy.innerHTML = 'something'
    function Ball(r, p, v) {
        this.radius = r;
        this.point = p;
        this.vector = v;
...
<body>
    ...
    <div class='form-container'>
        ...
        <form method='post' class="login-form">
            ...
            <div class="form-group">
                <input type='submit' class="login-btn" name='login_submit' value="login"/>
            </div>
        </form>
    </div>
</body>
