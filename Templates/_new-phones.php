...
<section id="new-phones">
    <div class="container">
        <h4 class="font-narrow font-size-20">New Phones</h4>
        <hr>
        <!-- owl carousel -->
                ...
                <div class="product font-calibri">
                    ...
                    <div class="text-center">
                        ...
                        <?php 
                            ...
                            if(!isset($_SESSION['login'])){
                                echo '<button type="button" class="btn btn-warning font-size-12" name="new_phones_submit" data-toggle="modal" data-target="#modelId">Add to Cart</button>';
                            }else{
                                echo '<button type="submit" class="btn btn-warning font-size-12" name="new_phones_submit">Add to Cart</button>';    
                            }                                    
                        }?>
                        </form>                                
                        </div>
